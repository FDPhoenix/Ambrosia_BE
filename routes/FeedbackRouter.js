...
const { createFeedback, getFeedbackByDishId, updateFeedback, deleteFeedback, hideFeedback, getAllDishes, getAllFeedbackByDishIdAdmin, checkUserFeedback } = require('../controllers/FeedbackController');
...
router.get('/check/:dish_id/:orderId', isAuthenticated, checkUserFeedback);
